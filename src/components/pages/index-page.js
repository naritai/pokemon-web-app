  ...
  return (
    <div className='index-page'>
      ...
      <p>
        ...
        also collectively refers to the 809 fictional species that have made
        appearances in Pokémon media as of the release of the seventh generation
        titles Pokémon: Let's Go, Pikachu! and Let's Go, Eevee! "Pokémon" is
